...
<div class="logged-user-w">
	<div class="logged-user-i">
		<div class="avatar-w"><img alt="" src="http://gonextlevel.consilio.com.br/public/img/avatar1.jpg"></div>
		<div class="logged-user-menu color-style-bright">
			<div class="logged-user-avatar-info">
				<div class="avatar-w"><img alt="" src="http://gonextlevel.consilio.com.br/public/img/avatar1.jpg"></div>
				<div class="logged-user-info-w">
					<div class="logged-user-name">Humberto Martins</div>
					<div class="logged-user-role">Administrador</div>
				</div>
			</div>
			...
			<ul>
				...
				<li><a href="#"><i class="icon-feather-award"></i><span>Assinatura</span></a></li>
				<li><a href="#"><i class="os-icon os-icon-others-43"></i><span>Notificações</span></a></li>
				<li><a href="#"><i class="os-icon os-icon-signs-11"></i><span>Sair</span></a></li>
			</ul>
		</div>
	</div>
</div>
