...
$(function () {
	...
	$('input.multi-daterange').daterangepicker({
		...
		"startDate": "01/01/2018", "endDate": "01/12/2018"
	});
	...
	$('input.timepicker-without-dropdown').timepicker({
		dropdown: false,
		timeFormat: 'HH:mm'
	});
	...
	if (typeof Chart !== 'undefined') {
		...
		if ($("#liteLineChart").length) {
			...
			if (liteLineChart.data('chart-data'))
				chartData = liteLineChart.data('chart-data').split(',');
		...
		if ($("#liteLineChartV2").length) {
			...
			if (liteLineChartV2.data('chart-data'))
				chartDataV2 = liteLineChartV2.data('chart-data').split(',');
		...
		if ($("#barChart1").length) {
			...
			var barData1 = {
				...
				datasets: [{
					label: "Apresentações",
					backgroundColor: ["#5797FC", "#5797FC", "#5797FC", "#5797FC", "#5797FC", '#5797FC', "#5797FC", "#5797FC", "#5797FC", "#5797FC", "#5797FC", '#5797FC'],
					borderColor: ['rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)', 'rgba(255,99,132,0)'],
					borderWidth: 1,
					data: [24, 42, 18, 0, 0, 0, 0, 0, 0, 0, 0, 0]
				},
					{
						label: "Cadastros",
						...
						borderWidth: 1,
						data: [13, 23, 5, 0, 0, 0, 0, 0, 0, 0, 0, 0]
					}]
			};
			// -----------------
			// init bar chart
	...
	if ($('.onboarding-modal .onboarding-slider-w').length) {
		$('.onboarding-modal .onboarding-slider-w').slick({
			...
			slidesToShow: 1,
			slidesToScroll: 1,
			nextArrow: '<button class="slick-next slick-arrow" aria-label="Próximo" type="button" style="" aria-disabled="false">Próximo</button>',
			prevArrow: '<button class="slick-prev slick-arrow" aria-label="Anterior" type="button" style="display: inline-block;" aria-disabled="false">Anterior</button>'
